...
import { Hand, Pen, Highlighter, Undo2, Redo2, Trash2, ArrowRight, Eraser } from 'lucide-react-native';
...
export default function CanvasToolbar({
  ...
  const tools: Array<{ tool: DrawTool; Icon: React.ComponentType<{ size: number; color: string }> }> = [
    { tool: 'pan', Icon: Hand },
    { tool: 'pen', Icon: Pen },
